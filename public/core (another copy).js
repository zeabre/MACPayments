// public/core.js
//var scotchVendor = angular.module('scotchVendor', []);
...
*/	
    ...
    $scope.createAppt = function() {
			...
			var sDate = new Date(sYear,sMonth,sDay,$scope.picker2.appointmentPicker.time.h,$scope.picker2.appointmentPicker.time.m);
    ...
    $scope.getTime = function() {
		...
		$http.get('/api/bookings/' + $scope.formData.pt_appt_practice + '/' + sYear + '/' + sMonth + '/' + sDay)
            .success(function(data) {
                ...
                console.log(data);
                console.log("Picker: " + $scope.picker2);
		})
            .error(function(data) {
                console.log('Error: ' + data);
		});
		...
		$scope.picker2 = $('#time-2').appointmentPicker({
